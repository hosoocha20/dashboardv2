  ...
  return (
    <li className="importantTaskItem">
        <div className="important-group">
            <input type="checkbox" className='checkbox' checked={starred} name={important.name} id={important.id} 
        ...
        <div className="cursor-pointer select-none">
            {isActive? 
                <IconContext.Provider value={{color:"#8DB8FC"}}>
                    <RxStar  size="20px" onClick={()=>{setIsActive(!isActive)}} />
                </IconContext.Provider>
                :
                <IconContext.Provider value={{color:"#8DB8FC"}}>
                    <RxStarFilled  size="20px" onClick={()=>{handleStarChange()}} />
                </IconContext.Provider>
            }
        </div>

...
const MainTodo = () => {
  ...
  const [starredTasks, setStarredTasks] = useLocalStorage(
    "tasks.starredTasks",
    []
  );
  ...
  const [mainTodoHeight, setMainTodoHeight] = useState(
    window.innerHeight - 172
  );
        ...
        <div className="List-Container" style={mainTodoContainerStyle}>
          {mainTasks && (
            <MainTodoList
              ...
              addStarredTask={addStarredTask}
              removeStarredTask={removeStarredTask}
              isEditingMainTask={isEditingMainTask}
              ...
              toggleCompletedStarredTask={toggleCompletedStarredTask}
              mainTodoHeight={mainTodoHeight}
            />
          )}
          {completedTasks && (
            <CompletedTodoList
              ...
              toggleCompletedTaskStarred={toggleCompletedTaskStarred}
              addStarredTask={addStarredTask}
              removeStarredTask={removeStarredTask}
              toggleCompletedStarredTask={toggleCompletedStarredTask}
            />

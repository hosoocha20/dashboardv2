...
const MainTaskItem = ({mainTask, deleteMainTask, enterMainTaskEditMode, addCompletedTask, toggleTaskStarred, addStarredTask, removeStarredTask, toggleCompletedStarredTask}) => {
